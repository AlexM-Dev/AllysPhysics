...
namespace AllysPhysics {
    class ReverseChaoticPhysics : PhysicsSet {
        public string Name { get; set; }
        public string Description { get; set; }
        public ReverseChaoticPhysics() {
            Name = "Reverse Chaotic Physics";
            Description = "Physics that don't always set both x+y - based on REVERSE.";
        }
